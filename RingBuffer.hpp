 ...
 */
void put_arr(const char *data, ring_buffer_size_t size);
 ...
 */
ring_buffer_size_t get_arr(char *data, ring_buffer_size_t len);
 ...
 * @return 1 if data was returned; 0 otherwise.
 */
uint8_t peek(char *data, ring_buffer_size_t index);
